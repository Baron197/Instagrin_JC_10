...
class PostDetailOtherProfileHome extends Component {
    render() {
        return (
            <View>
                <Header
...
const mapStateToProps = ({ post }) => {
    ...
    return {
        ...post.selectedPostDetailOtherProfileHome
    }
}

export default connect(mapStateToProps)(PostDetailOtherProfileHome);
